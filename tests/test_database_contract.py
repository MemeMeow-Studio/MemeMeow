...
from backend.database import Base, EMBEDDING_DIMENSIONS, BlobStore, DatabaseError, ScopeContext
...
def test_schema_contains_scope_and_queue_tables():
    ...
    expected = {"scopes", "installation_state", "memes", "storage_operations", "search_generations", "search_heads", "meme_embeddings", "tasks", "task_batches", "task_batch_items", "task_lane_slots"}
